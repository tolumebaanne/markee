...
async function main() {
  ...
  const superuserPerms = {
    ...
    payments:      allTrue('read', 'refund', 'release', 'partialRefund', 'freeze', 'splitRefund', 'resolveDisputes', 'payoutHold', 'remit'),
  ...
  const templates = [
    ...
    },
    {
      ...
      permissions: {
        ...
        catalog:       make('read'),
        orders:        make('read'),
        payments:      make('read', 'refund', 'release', 'partialRefund', 'freeze', 'splitRefund', 'resolveDisputes', 'payoutHold', 'remit'),
        sellers:       make('read'),
        reviews:       make('read'),
        messages:      make('read'),
        notifications: make('read'),
